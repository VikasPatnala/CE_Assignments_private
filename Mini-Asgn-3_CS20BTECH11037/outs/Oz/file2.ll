...
; Function Attrs: minsize mustprogress nofree nosync nounwind optsize willreturn memory(none) uwtable
...
6:                                                ; preds = %2
  %7 = add nsw i32 %4, -1
  %8 = tail call noundef i32 @_Z9fibonaccii(i32 noundef %7) #5
  %9 = add nsw i32 %4, -2
  %10 = add nsw i32 %8, %3
  br label %2
...
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  ...
  %6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(ptr noundef nonnull align 8 dereferenceable(8) %5) #5
...
attributes #0 = { minsize mustprogress nofree nosync nounwind optsize willreturn memory(none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
